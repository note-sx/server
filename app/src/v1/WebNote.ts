...
const htmlTemplate = readFileSync(__dirname + '/templates/note.html', 'utf8')
const decryptionFunctions = '<script>' + readFileSync(__dirname + '/templates/decrypt.js', 'utf8') + '</script>'
